                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                          onPressed: () async {
                            await _gertecPrinterPlugin.printQrcode(text: 'EU AMO FLUTTER', align: 20, width: 100);
                          },
                          child: const Text('Print qrCode')),
                      ElevatedButton(
                          onPressed: () async {
                            await _gertecPrinterPlugin.printBarCode(text: '1234567890', width: 100, type: BarCodeType.BARCODE_TYPE_JAN13, textPostion: BarCodeTextPosition.TEXT_NONE);
                          },
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          ...
                          await _gertecPrinterPlugin.printImage(image: byte, align: PrintAlign.LEFT, paper: GertecPaperSize.PAPER_80);
                        },
                        child: Column(
                          children: [
                            Image.asset(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                    ElevatedButton(
                        onPressed: () async {
                          ...
                          await _gertecPrinterPlugin.printRaw(Uint8List.fromList(escPos));
                        },
